...
//import static com.codingspider.jantatransport.janttrans.login_and_reg.LoginActivity.MY_PREFS_NAME;

public class BookShare extends AppCompatActivity {

    public static final int CONNECTION_TIMEOUT = 10000;
    public static final int READ_TIMEOUT = 15000;
    private RecyclerView mRVFishPrice;
    private AdapterShare mAdapter;
    String f="0",booktype ="HS";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activities_book_share);


        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

       /* sharedpreferences = getSharedPreferences(MyPREFERENCES, Context.MODE_PRIVATE);
        phone1 = sharedpreferences.getString("editTextphone1", "");
        System.out.println("SHARED PHONE VALUE ="+phone1);*/
    ...
    private void register1(String origin, String destination, String cateId, String KMPL, String duration, String f, String phone2, String cate_price, String booktype, String date, String time) {
        ...
        class RegisterUser extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(BookShare.this, "Please Wait",null, true, true);
            }
